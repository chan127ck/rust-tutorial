...
// Paths: A way to naming an item such as struct, function
mod pizza_order {
    pub struct Pizza {
        pub dough: String,
        pub cheese: String,
